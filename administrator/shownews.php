...
<table width="798" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td align="center" valign="top" background="images/bg_center.gif"><table width="95%"  border="0" cellpadding="0" cellspacing="0" class="mini-font">
		...
		<?php
			$query="SELECT * FROM app_news WHERE news_id='$id'";
        ...
        <tr valign="bottom">
          ...
          <td rowspan="2" align="right">
		  		<a href="editnews.php?<?= "n=".$out["news_id"]; ?>"><img src="images/i_edit.png" width="16" height="16" border="0" title="edit"></a>
                <a href="actionNews.php?<?= "n=".$out["news_id"]."&act=setactiveflag&flag=".$out["active_flag"]; ?>"><img src="images/i_lock.png" width="16" height="16" border="0" title="active flag"></a>
                <a href="actionNews.php?<?= "n=".$out["news_id"]."&act=delete"; ?>"><img src="images/i_delete.png" width="16" height="16" border="0" title="delete"></a>
        </tr>
        <tr valign="bottom">
